        ...
        try {
            ...
            const foundOrders = [
                ...foundBookings.map((booking: any) => ({
                    ...
                    bikeImage: booking.Bike?.image ? (booking.Bike.image.startsWith('http') ? booking.Bike.image : `https://storage.googleapis.com/bike_images/${booking.Bike.image}`) : bike1,
                ...
                ...foundRentals.map((rental: any) => ({
                    ...
                    bikeImage: rental.Bike?.image ? (rental.Bike.image.startsWith('http') ? rental.Bike.image : `https://storage.googleapis.com/bike_images/${rental.Bike.image}`) : bike1,
